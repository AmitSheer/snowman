...
std::string build_face(array<int,8> types){
    std::string face = left_arm_tops[types[LEFT_ARM]-1]+"("+left_eyes[types[LEFT_EYE]-1]+noses[types[NOSE]-1]+right_eyes[types[RIGHT_EYE]-1]+")"+right_arm_tops[types[RIGHT_ARM]];
    return face;
}
